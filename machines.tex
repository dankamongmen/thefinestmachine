...
\vspace{2mm}
\raggedleft{\tiny---Wernher Von Braun, ``Why I Believe in Immortality'', as quoted in Thomas Pynchon's\\
\emph{Gravity's Rainbow} (1973), from \emph{The Third Book of Words to Live By}, W. Nichols (ed.) (1962)}\\
\end{quote}
\vspace{.2in}
...
``Leopold Kronecker'', \emph{Annals of Mathematics} Vol.\ 43, No.\ 1 (1892)}
\protect\end{quote}
}
...
\protect\raggedleft{\footnotesize---\greektext<Ηράκλειτος\latintext\ (Heraclitus the Ephesian),
...
\chapter{Communication networks. Hypercubes, butterflies and banyans. Infinity machines, and their
limitations.}
...
transformations among space, state, time and portability. Is computation energy?}

\chapter{Parallelism among bits, registers, instructions, memories, and threads. The
Taxonomy of Flynn. Hardware absurdities.}
