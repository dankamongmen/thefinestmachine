...
\raggedleft{\footnotesize--Leopold Kronecker, as quoted in H. Weber's ``Leopold Kronecker'',\\
...
\raggedleft{\footnotesize--John Archibald Wheeler, \emph{It from Bit} (1989)}
\end{quote}
\hrule
