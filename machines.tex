...
\raggedleft{\footnotesize--Seth Lloyd, ``Ultimate Physical Limits to Computation'',\\
\emph{Nature} 406 (2000-08-31)}
\end{quote}
\hrule
\emph{PART IV: THE INELUCTABLE MODALITY OF STATE}
\begin{quote}``\emph{\greektextμεταβάλλον αναπαύεται\latintext.}''\\
(``Even while it changes, it stands still.'')\\
\raggedleft{\footnotesize--Heraclitus, as quoted in Abelson and Sussman's\\
...
\raggedleft{\footnotesize--Ludwig Wittgenstein,\\
\emph{Tractatus Logico-Philosophicus} (1918)}
\end{quote}
\hrule
\clearpage
...
(``God made integers; all else is the work of man.'')\protect \\
\protect \raggedleft{\footnotesize--Leopold Kronecker, as quoted in H. Weber's ``Leopold Kronecker'',\protect \\
\emph{Mathematische Annalen} Vol.\ 43, No.\ 1 (1892)}
\protect
\end{quote}
\par
}
